...
func main() {
	content, err := os.ReadFile("../../../inputs/2018/day02/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2018/day02/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2018/day02/input.txt")
