...
func main() {
	content, err := os.ReadFile("../../../inputs/2018/day14/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2018/day14/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2018/day14/input.txt")
