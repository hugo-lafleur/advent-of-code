...
func main() {
	content, err := os.ReadFile("../../../inputs/2018/day13/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2018/day13/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2018/day13/input.txt")
