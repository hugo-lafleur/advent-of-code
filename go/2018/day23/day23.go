...
func main() {
	content, err := os.ReadFile("../../../inputs/2018/day23/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2018/day23/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2018/day23/input.txt")
