...
func main() {
	content, err := os.ReadFile("../../../inputs/2017/day20/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2017/day20/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2017/day20/input.txt")
