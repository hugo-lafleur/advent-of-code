...
func main() {
	content, err := os.ReadFile("../../../inputs/2017/day02/test1.data")
	...
	content, err = os.ReadFile("../../../inputs/2017/day02/test2.data")
	...
	content, err = os.ReadFile("../../../inputs/2017/day02/input.data")
