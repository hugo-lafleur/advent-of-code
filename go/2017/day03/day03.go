...
func main() {
	content, err := os.ReadFile("../../../inputs/2017/day03/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2017/day03/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2017/day03/input.txt")
