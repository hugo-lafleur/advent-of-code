...
func main() {
	content, err := os.ReadFile("../../../inputs/2019/day06/test1.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day06/test2.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day06/input.data")
