...
func main() {
	content, err := os.ReadFile("../../../inputs/2019/day20/test1.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day20/test2.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day20/input.data")
