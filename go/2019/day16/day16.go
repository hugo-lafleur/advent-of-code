...
func main() {
	content, err := os.ReadFile("../../../inputs/2019/day16/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2019/day16/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2019/day16/input.txt")
