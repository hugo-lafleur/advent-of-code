...
func main() {
	content, err := os.ReadFile("../../../inputs/2019/day08/test1.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day08/test2.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day08/input.data")
