...
func main() {
	content, err := os.ReadFile("../../../inputs/2019/day18/test1.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day18/test2.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day18/input1.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day18/input2.data")
