...
func main() {
	content, err := os.ReadFile("../../../inputs/2019/day07/test1.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day07/test2.data")
	...
	content, err = os.ReadFile("../../../inputs/2019/day07/input.data")
