...
func main() {
	content, err := os.ReadFile("../../../inputs/2022/day09/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2022/day09/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2022/day09/input.txt")
