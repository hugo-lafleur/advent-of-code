...
func main() {
	content, err := os.ReadFile("../../../inputs/2023/day01/test1.data")
	...
	content, err = os.ReadFile("../../../inputs/2023/day01/test2.data")
	...
	content, err = os.ReadFile("../../../inputs/2023/day01/input.data")
