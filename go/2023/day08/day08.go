...
func main() {
	content, err := os.ReadFile("../../../inputs/2023/day08/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2023/day08/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2023/day08/input.txt")
