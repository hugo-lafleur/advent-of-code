...
func main() {
	content, err := os.ReadFile("../../../inputs/2021/day16/test1.data")
	...
	content, err = os.ReadFile("../../../inputs/2021/day16/test2.data")
	...
	content, err = os.ReadFile("../../../inputs/2021/day16/input.data")
