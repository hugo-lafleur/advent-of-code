...
func main() {
	content, err := os.ReadFile("../../../inputs/2021/day22/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2021/day22/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2021/day22/input.txt")
