...
func main() {
	content, err := os.ReadFile("../../../inputs/2020/day04/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2020/day04/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2020/day04/input.txt")
