...
func main() {
	content, err := os.ReadFile("../../../inputs/2020/day19/test1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2020/day19/test2.txt")
	...
	content, err = os.ReadFile("../../../inputs/2020/day19/input1.txt")
	...
	content, err = os.ReadFile("../../../inputs/2020/day19/input2.txt")
